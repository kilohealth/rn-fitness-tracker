...
export declare const HealthDataTypes: Readonly<{
  // Dietary
...
export declare type HKDataTypeMap = typeof HealthDataTypes;
...
export declare const UnitTypes: Readonly<{
  grams: 'g';
  kilograms: 'kg';
  milligrams: 'mg';
  micrograms: 'mcg';
...
export declare type HKUnitMap = typeof HealthDataTypes;
export declare type HKUnit = ValueOf<HKUnitMap>;

export declare const WorkoutTypes: Readonly<{
  AmericanFootball: 1;
  Archery: 2;
...
export declare type HKWorkoutMap = typeof HealthDataTypes;
